...
System.out.println("prices[0] =" + prices[0]);; // default 0.0
 ...
 System.out.println("groceryList[0] = " + groceryList[0]); // null

            //TODO Together: What if we try to refer to an index beyond what we have set up?
//            System.out.println("sidesArray[0] =" + sidesArray[6]);// we will get an error out of bounds!
...
System.out.println("Hey good to see you today" + cohorts[0] + "students! Did you know that Codeup has these other cohorts?" + cohorts[3]);
            ...
            String[] myBabies = new String[4];
            myBabies [0] = "Benny";
            myBabies [1] = "Dolly";
            myBabies [2]="Yusi";
            myBabies [3] ="Ayah";

            String[] babies = {"Benny", "Dolly" , "yusi", "ayah"};

            System.out.println(myBabies[0]);
            System.out.println(babies[1]);
...
//    "Codeup has anumber of cohorts! One of them is the " + cohorts[1] + "cohort.";
//}
//            //enhanced for (loop : loops){}
//            //TODO Together: Java also provides an enhanced for [for (ele : arr) {}] to use!
//for(String cohort: cohorts) { // for (data type singular: arrName {do some stuff}
//    System.out.println("Codeup runs a few cohorts at a time - one of the one form 2021 is " + cohort)
//
//}
...
for(String baby : myBabies){
    System.out.println("I have four nieces and nephews. One of them is " + baby + "!");
}
...
System.out.println("Arrays.eqausls(groceryList, groceryList) = " + Arrays.equals(groceryList, groceryList));
...
//System.out.println(cohortNamesString + " cohorts are reporting for duty!");
