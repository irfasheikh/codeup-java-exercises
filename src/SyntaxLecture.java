...
//string variable double string  is string literal
...
int age = 12;
        ...
        // ================== IDENTIFIERS AND KEYWORDS identifier =class, variable, method

        // see curriculum const is final in java
...
int d20 = SIDES_OF_A_DICE + 14;
        ...
        // IMPLICIT
//short x = 5; // cannot do this bc its already assigned in this scope (this method)
        short y = 5;
